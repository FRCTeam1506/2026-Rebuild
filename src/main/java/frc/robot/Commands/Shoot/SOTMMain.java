...
public class SOTMMain extends ParallelCommandGroup {
    ...
    public SOTMMain(CommandSwerveDrivetrain drivetrain, Shooter shooter, Hopper hopper, Intake intake, DoubleSupplier x, DoubleSupplier y) {
    addCommands(
        new AlignOnTheMoveNew(drivetrain, x, y),
        new AutoSOTMNew(shooter, hopper),
